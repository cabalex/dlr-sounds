<script lang="ts">
  ...
  import AudioPlayer from './lib/player/AudioPlayer.svelte';
...
<main>
  ...
  <footer>
    <p>
      A rewrite of
      <a rel="noreferrer" target="_blank" href="http://soundsofdisneyland.com/">Sounds of Disneyland</a>, with artwork by <a rel="noreferrer" target="_blank" href="https://www.tshergdesign.com/">Tony Sherg</a> and track lists by <a href="https://dlrmusicloops.com/">DLRMusicLoops</a>-- go check them out!
    </p>
    ...
    dlr-sounds v11 - <a rel="noreferrer" target="_blank" href="https://cabalex.github.io">cabalex 2023</a>
  </footer>
</main>
